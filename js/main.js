...
{
	var win = window.open( 'https://web.archive.org/web/20130228134613/http://store.steampowered.com/gotflash','gotflash','width=536,height=546,resize=yes,scrollbars=yes');
	win.focus();
}
...
function PageTab( tab, delta, max, params )
{
	...
	if ( tabStart[tab] > tabMax[tab] )
	{
		...
		new Ajax.Updater( 
				'tab_' + tab + '_items', 
				'https://web.archive.org/web/20130228134613/http://store.steampowered.com/search/tab', 
...
{	
	...
	if ( elem.curPos > elem.maxLoaded )
	{
		...
		new Ajax.Updater( 
				targetid, 
				'https://web.archive.org/web/20130228134613/http://store.steampowered.com/search/smallcapscroll', 
			...
			window.setTimeout( function() { 
				if ( elem.bWantsHover && !elem.ajaxRequest ) {
					elem.ajaxRequest = new Ajax.Updater( hover.down('.content'),
								'https://web.archive.org/web/20130228134613/http://store.steampowered.com/' + strUrlTarget + rgHoverData['id'],
...
{
	var url = 'https://web.archive.org/web/20130228134613/http://store.steampowered.com/api/addtowishlist';
	if ( navref )
...
{
	$(divBtn).hide();
	var url = 'https://web.archive.org/web/20130228134613/http://store.steampowered.com/friends/recommendgame';
	if ( navref )
		MakeNavCookie( navref, url );
...
function HideRecommendation( type, itemid, divBtn, elemContainer )
{
	...
	new Ajax.Request( 'https://web.archive.org/web/20130228134613/http://store.steampowered.com/recommended/ignorerecommendation/', {
		method: 'post',
...
function LaunchWebChat()
{
	...
	iframe.hide();
	iframe.src='https://web.archive.org/web/20130228134613/http://steamcommunity.com/chat/launch/'
...
/*
     FILE ARCHIVED ON 13:46:13 Feb 28, 2013 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  load_resource: 153.641 (2)
  PetaboxLoader3.resolve: 92.475 (2)
  PetaboxLoader3.datanode: 56.868 (2)
*/